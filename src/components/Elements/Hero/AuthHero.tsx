const AuthHero = () => {
    return (
        <aside className="hidden md:flex w-[480px] h-[610px] lg:w-[500px] 2xl:w-[680px] 2xl:h-[926px] hero-auth bg-cover overflow-hidden bg-no-repeat rounded-[24px] flex-col justify-end bg-center ">
